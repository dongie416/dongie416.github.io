...
<ol> Centroid -> A triangle center that is found by discovering the intersection of the medians of the triangle that connects with each vertex of the triangle. (Always in the Triangle.)
